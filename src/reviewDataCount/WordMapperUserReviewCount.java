 ...
 * Apr 6, 2017
 * WordMapperUserReviewCount.java
 */

public class WordMapperUserReviewCount extends Mapper<LongWritable, Text, Text, Text>{
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
		...
		try {
			...
			business_id = (String) json.get("business_id");
			stars = json.get("stars").toString(); 
			date = (String) json.get("date");
			//text = (String) json.get("text");
			useful = (String) json.get("useful");
		...
		Text OutKey = new Text (business_id);
		Text OutValue = new Text (user_id);
