...
public class MainClassSentimentAnalysis {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException,InterruptedException {
		...
		conf.set("starfile", "hdfs://nashville:30261" + "/featureCount/part-r-00000");
		//conf.set("negWords", "hdfs://phoenix:30201" + "/projectData/neg-words.txt");
		//conf.set("posWords", "hdfs://phoenix:30201" + "/projectData/pos-words.txt");
		//conf.set("starfile", "hdfs://phoenix:30201" + "/featureData/part-r-00000");
		...
		job1.setMapperClass(WordMapperAverage.class);
		job1.setReducerClass(WordReducerAverage.class);
