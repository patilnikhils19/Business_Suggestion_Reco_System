...
np.save("X_total_svm3_attr", X_total)

X_total = np.load('X_total_svm3_attr.npy')
...
joblib.dump(clf, 'svm_2_attr.pkl')
...
np.save("rep_svm_rbf.npy", report)
cmat = confusion_matrix(data_y_test, predicted)
np.save("cmat_svm_rbf.npy", cmat)
...
#           4       0.00      0.00      0.00      1514
#           5       0.23      0.04      0.07      2617
#           6       0.00      0.00      0.00      4313
#           7       0.29      0.24      0.26      5441
#           8       0.26      0.43      0.32      6256
#           9       0.20      0.00      0.00      4278
#          10       0.24      0.80      0.37      4421
#
# avg / total       0.19      0.25      0.18     30000
