...
np.save("X_total_svm4_attr", X_total)

X_total = np.load('X_total_svm4_attr.npy')
...
joblib.dump(clf, 'linearsvc_attr.pkl')

cmat = metrics.confusion_matrix(data_y_test, predicted)
...
#           4       0.22      0.03      0.06      1020
#           5       0.26      0.01      0.02      1787
#           6       0.21      0.04      0.07      2885
#           7       0.27      0.21      0.24      3626
#           8       0.27      0.45      0.34      4155
#           9       0.25      0.01      0.01      2828
#          10       0.25      0.78      0.38      2933
#
# avg / total       0.24      0.26      0.19     20000
